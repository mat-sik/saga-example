...
public class DeleteUserTaskListener implements ChannelAwareMessageListener {
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        var deleteUserMessage = (DeleteUserTask) converter.fromMessage(message, DeleteUserTask.class);
