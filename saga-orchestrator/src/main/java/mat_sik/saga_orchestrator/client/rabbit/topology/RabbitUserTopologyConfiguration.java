...
import mat_sik.saga_orchestrator.client.rabbit.topology.property.UserDirectExchangeTopologyConfigurationProperty;
...
@Configuration
public class RabbitUserTopologyConfiguration {
    ...
    public RabbitUserTopologyConfiguration(UserDirectExchangeTopologyConfigurationProperty topologyConfigurationProperty) {
